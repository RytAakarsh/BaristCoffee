...
//               value={email}
//               onChange={(e) => setEmail(e.target.value)}
//               className="w-full px-4 py-2 border border-border rounded-lg bg-input text-foreground focus:ring-2 focus:ring-primary"
//               required
//             />
//           </div>
...
//             type="submit"
//             disabled={isLoading}
//             className="w-full px-4 py-3 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition disabled:opacity-50"
//           >
//             {isLoading ? "..." : t.submit}
//           </button>
//         </form>
...
//         <button onClick={onClose} className="w-full mt-2 text-sm text-muted-foreground">
//           ✕ Close
//         </button>
//       </div>
//     </div>
...
//     if (email === ADMIN_EMAIL && password === ADMIN_PASSWORD) {
//       localStorage.setItem("admin-auth", "true"); // SAVE LOGIN STATE
//       setIsLoading(false);
//       onClose();
//       router.push("/admin"); // DIRECT REDIRECT
//       return;
//     }
...
//       // TELL PARENT LOGIN IS SUCCESSFUL
//       onSuccess();
